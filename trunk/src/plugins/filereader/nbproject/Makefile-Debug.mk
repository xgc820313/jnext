...
${OBJECTDIR}/_ext/root/jnext/src/plugins/database/SQLite3/../../common/plugin.o: ../../common/plugin.cpp 
	...
	$(COMPILE.cc) -g -I../../../../../soci-2.2.0/src/core;../../../../../soci-2.2.0/src/backends/sqlite3 -o ${OBJECTDIR}/_ext/root/jnext/src/plugins/database/SQLite3/../../common/plugin.o ../../common/plugin.cpp

${OBJECTDIR}/SQLite3.o: SQLite3.cpp 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.cc) -g -I../../../../../soci-2.2.0/src/core;../../../../../soci-2.2.0/src/backends/sqlite3 -o ${OBJECTDIR}/SQLite3.o SQLite3.cpp
...
${OBJECTDIR}/_ext/root/jnext/src/plugins/database/SQLite3/../Database.o: ../Database.cpp 
	...
	$(COMPILE.cc) -g -I../../../../../soci-2.2.0/src/core;../../../../../soci-2.2.0/src/backends/sqlite3 -o ${OBJECTDIR}/_ext/root/jnext/src/plugins/database/SQLite3/../Database.o ../Database.cpp

${OBJECTDIR}/sqlite3.o: sqlite3.c 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.c) -g -o ${OBJECTDIR}/sqlite3.o sqlite3.c
