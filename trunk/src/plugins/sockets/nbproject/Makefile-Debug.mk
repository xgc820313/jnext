...
/usr/lib/firefox/plugins/jnext/Sockets.so: ${OBJECTFILES}
	...
	${LINK.cc} -fno-rtti -fno-exceptions -rdynamic -lrt -shared -o /usr/lib/firefox/plugins/jnext/Sockets.so ${OBJECTFILES} ${LDLIBSOPTIONS} 
...
${OBJECTDIR}/_ext/root/jnext/src/plugins/sockets/../common/plugin.o: ../common/plugin.cpp 
	...
	$(COMPILE.cc) -g -I/root/pwlib/include -o ${OBJECTDIR}/_ext/root/jnext/src/plugins/sockets/../common/plugin.o ../common/plugin.cpp
