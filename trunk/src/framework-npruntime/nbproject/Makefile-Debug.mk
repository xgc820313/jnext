...
/usr/lib/firefox/plugins/jnext.so: ${OBJECTFILES}
	...
	${LINK.cc} -fno-rtti -fno-exceptions -lrt -shared -o /usr/lib/firefox/plugins/jnext.so ${OBJECTFILES} ${LDLIBSOPTIONS} 
...
${OBJECTDIR}/_ext/root/jnext/src/framework-npruntime/../common/binreloc.o: ../common/binreloc.c 
	...
	$(COMPILE.c) -g -DENABLE_BINRELOC -o ${OBJECTDIR}/_ext/root/jnext/src/framework-npruntime/../common/binreloc.o ../common/binreloc.c

${OBJECTDIR}/_ext/root/jnext/src/framework-npruntime/../common/SharedLib.o: ../common/SharedLib.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/root/jnext/src/framework-npruntime/../common
	$(COMPILE.cc) -g -DENABLE_BINRELOC -DXPCOM_GLUE -DMOZILLA_STRICT_API -DXP_UNIX -DMOZ_X11 -Igecko-sdk/include -I/root/pwlib/include -o ${OBJECTDIR}/_ext/root/jnext/src/framework-npruntime/../common/SharedLib.o ../common/SharedLib.cpp
...
${OBJECTDIR}/_ext/root/jnext/src/framework-npruntime/../common/nativelogic.o: ../common/nativelogic.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/root/jnext/src/framework-npruntime/../common
	$(COMPILE.cc) -g -DENABLE_BINRELOC -DXPCOM_GLUE -DMOZILLA_STRICT_API -DXP_UNIX -DMOZ_X11 -Igecko-sdk/include -I/root/pwlib/include -o ${OBJECTDIR}/_ext/root/jnext/src/framework-npruntime/../common/nativelogic.o ../common/nativelogic.cpp
